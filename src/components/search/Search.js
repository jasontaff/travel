        ...
        <div name="book" className="search">
            <div className="container">
                <div className="left">
                    ...
                    <p>asdfasdf asdf asdfasdf asdf asdf asfdasddf asdfasdf asdf asdfasdf asdf asdf asfdasddasdfasdf asdf asdfasdf asdf asdf asfdasddasdfasdf asdf asdfasdf asdf asdf asfdasddasdfasdf asdf asdfasdf asdf asdf asfdasdd</p>
                ...
                <div className="right">
                    ...
                    <form>
                        ...
                        <button>Rates & Availibilites</button>
                    </form>
                </div>
            </div>
        </div>
